...
class TestUserWorkflows:
    ...
    def test_new_user_setup_workflow(self, project_root):
        ...
        setup_files = ["requirements.txt", "README.md", "pyproject.toml"]
    ...
    def test_testing_workflow(self, project_root):
        ...
        essential_test_files = ["test_basic_functionality.py", "test_safe_integration.py", "conftest.py"]
...
class TestConfigurationScenarios:
    ...
    def test_debug_vs_release_configuration(self, project_root):
        ...
        if bin_dir.exists():
            ...
            config_paths = [bin_dir / "Debug", bin_dir / "Release"]
...
class TestCrossEnvironmentCompatibility:
    ...
    def test_development_vs_production_behavior(self, project_root):
        ...
        dev_indicators = [project_root / "tests", project_root / ".git", project_root / "scripts"]
